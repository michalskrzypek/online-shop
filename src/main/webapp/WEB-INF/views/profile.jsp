            ...
            <div class="well well-sm">
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <img src="${images}/Account_${account.getId()}.jpg" alt="No photos available!" class="img-rounded img-responsive profileImg" />
                        <br>
                        <form action="${pageContext.request.contextPath }/profile/addPhoto" method="post" enctype="multipart/form-data">
          ...
          <div class="page-header">
            ...
            <div class="well well-sm">
                <div class="row">
                    ...
                    <c:when test="${shippingAddresses == null or shippingAddresses.size() == 0}">
                    
                    <div>
                    <em class="help-block">You have no shipping addresses.</em>
                    </div>                   
                    
                   <a href="${pageContext.request.contextPath}/profile/add/address?address=shipping"><span class="btn btn-primary">
                                Add address</span></a>  
                    ...
                    <p>
                    <b>Street:</b><i> ${address.getStreet() }</i><br>
                    <b>City:</b><i> ${address.getCity() }</i><br>
                      <b>Postal Code:</b><i> ${address.getPostalCode() }</i><br>
                        <b>Country:</b><i> ${address.getCountry() }</i><br>
                    
                     </p>
                    </c:forEach>
                    <br>
                      <a href="${pageContext.request.contextPath}/profile/add/address?address=shipping"><span class="btn btn-primary">
                                Add another address</span></a>  
